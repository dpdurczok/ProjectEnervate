...
public final class AdaptiveEmcTooltipEvents {
    ...
    public static void onItemTooltip(ItemTooltipEvent event) {
        ...
        // A clean/unmarked base-EMC item is not sellable in ProjectEnervate, so
        // replace the inherited base tooltip instead of leaving a false value visible.
        applyUnverifiedTooltip(event.getToolTip());
    }
    ...
    private static void applyUnverifiedTooltip(List<Component> tooltip) {
        replaceWithSingleEmcLine(
                tooltip,
                Component.literal("EMC: 0 (UNVERIFIED)").withStyle(ChatFormatting.RED)
        );
    }
