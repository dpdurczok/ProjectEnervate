...
public final class ProjectEnervateMenus {
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<CelestialMappingMenu>> CELESTIAL_MAPPING = MENU_TYPES.register(
            "celestial_mapping",
            () -> IMenuTypeExtension.create(CelestialMappingMenu::new)
    );
