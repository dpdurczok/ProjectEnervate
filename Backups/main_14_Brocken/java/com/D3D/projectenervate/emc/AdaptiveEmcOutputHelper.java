...
public final class AdaptiveEmcOutputHelper {
    ...
    /**
     * Applies an explicit stack EMC budget without capping against ProjectE base EMC.
     * This is used only by the Celestial Mapping/course system, where the goal is
     * to multiply a known resource value rather than validate a recipe output.
     */
